...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Person person = new Person("Nguyen Van Vi");
    ...
    {
        System.out.println("Right Before Change Name " + person);
        person.setName("Nguyen Vi");
    ...
    public static void dumpMethod(String[] args)
    {
        // Approach 1
